...
const List<ChallengeBadge> allBadges = [
  ...
  ChallengeBadge(id: 'oasis_finder', nameEn: 'Oasis Finder', nameAr: 'مكتشف الواحة', nameKu: 'دۆزەرەوەی ئۆئازیس', emoji: '💧', color: Color(0xFF00BCD4), stageRequired: 5, descriptionEn: 'Find the oasis', descriptionAr: 'اكتشف الواحة', descriptionKu: 'ئۆئازیس بدۆزەرەوە'),
  ...
  ChallengeBadge(id: 'summit_conqueror', nameEn: 'Summit Conqueror', nameAr: 'فاتح القمة', nameKu: 'داگیرکەری لووتکە', emoji: '🏔️', color: Color(0xFFE91E63), stageRequired: 13, descriptionEn: 'Reach the summit', descriptionAr: 'وصل للقمة', descriptionKu: 'بگەیە لووتکە'),
...
class ChallengeService extends ChangeNotifier {
  ...
  static const List<JourneyStage> journeyStages = [
    ...
    JourneyStage(stage: 5, nameEn: 'The Oasis', nameAr: 'الواحة', nameKu: 'ئۆئازیس', startDay: 21, endDay: 25, color: Color(0xFF00BCD4), icon: Icons.water_drop, emoji: '💧', descriptionEn: 'Finding peace within', descriptionAr: 'إيجاد السلام الداخلي', descriptionKu: 'دۆزینەوەی ئاشتی لە ناوەوە'),
    ...
    JourneyStage(stage: 13, nameEn: 'The Summit', nameAr: 'القمة', nameKu: 'لووتکە', startDay: 61, endDay: 65, color: Color(0xFFE91E63), icon: Icons.flag, emoji: '🏔️', descriptionEn: 'Reaching new heights', descriptionAr: 'الوصول إلى ارتفاعات جديدة', descriptionKu: 'گەیشتن بە بەرزایی نوێ'),
